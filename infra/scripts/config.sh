...
# EC2
export EC2_INSTANCE_NAME="${PROJECT_NAME}-${ENVIRONMENT}-ec2-bastion"
...
# Load Balancer
export ALB_NAME="${PROJECT_NAME}-${ENVIRONMENT}-alb-app"
export TARGET_GROUP_NAME="${PROJECT_NAME}-${ENVIRONMENT}-tg-app"
